...
namespace yol0Riven
{
    ...
    internal class Program
    {
        ...
        private static void OnGameUpdate(EventArgs args)
        {
            ...
            if (orbwalker.ActiveMode.ToString() == "Combo")
            {
                ...
                else
                {
                    ...
                    if (TargetSelector.GetSelectedTarget() != null && TargetSelector.GetSelectedTarget() != currentTarget &&
                        TargetSelector.GetSelectedTarget().IsVisible && TargetSelector.GetSelectedTarget().IsValidTarget())
                    {
                        currentTarget = TargetSelector.GetSelectedTarget();
                    }
        ...
        {
            currentTarget = TargetSelector.GetTarget(_e.Range + _q.Range + Player.AttackRange, TargetSelector.DamageType.Physical);
        }
